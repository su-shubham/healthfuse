...
const Header = () => {
  ...
  return (
    <div>
      <header>
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 rounded-lg :bg-[#ffc69b]">
            ...
            >
              ...
              to="/blogs"
                ...
                <li>
                  <a
                    href="#"
                    class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:text-orange-600 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 :text-gray-400 lg::hover:text-white :hover:bg-gray-700 :hover:text-white lg::hover:bg-transparent :border-gray-700"
                  >
                    Community
                  </a>
                </li>
